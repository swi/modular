...
Mojo’s [`layout` package](/mojo/stdlib/layout/) provides a number of APIs for
...
- The [`Layout`](/mojo/stdlib/layout/layout/Layout) struct describes an
...
- [`LayoutTensor`](/mojo/stdlib/layout/layout_tensor/LayoutTensor) is a flexible
  tensor type that combines a `Layout` and a pointer to data.
- The [`IntTuple`](/mojo/stdlib/layout/int_tuple/IntTuple) struct is a
...
The [`print_layout()`](/mojo/stdlib/layout/layout/print_layout) function
...
also provides an [`idx2crd()`](/mojo/stdlib/layout/layout/Layout#idx2crd) method
...
[`IntTuple`](/mojo/stdlib/layout/int_tuple/IntTuple) type. Each element of an
...
The [`int_tuple`](/mojo/stdlib/layout/int_tuple/) package provides a number of
functions for working with `IntTuple`. For example, it provides a
[`congruent()`](/mojo/stdlib/layout/int_tuple/congruent) function for testing
...
[`row_major()`](/mojo/stdlib/layout/layout/Layout/#row_major) and
[`col_major()`](/mojo/stdlib/layout/layout/Layout/#col_major) static methods are
...
[`tile_to_shape()`](/mojo/stdlib/layout/layout/tile_to_shape) function.
...
[`blocked_product()`](/mojo/stdlib/layout/layout/blocked_product) function. The
...
[`make_ordered_layout()`](/mojo/stdlib/layout/layout/make_ordered_layout)
